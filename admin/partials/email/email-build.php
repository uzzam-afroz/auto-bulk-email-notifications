...
{
    //Fetching Plugin Settings and Returning in Array
...
function aben_get_weekly_posts($selected_day_num)
{
    ...
    $days_since_selected =
        $current_day_of_week >= $selected_day_num ? $current_day_of_week - $selected_day_num : 7 - ($selected_day_num - $current_day_of_week);
