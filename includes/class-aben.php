...
class Aben
{
     ...
     *
     * - Aben_Loader. Orchestrates the hooks of the plugin.
     * - Aben_i18n. Defines internationalization functionality.
     * - Aben_Admin. Defines all hooks for the admin area.
     * - Aben_Public. Defines all hooks for the public side of the site.
     *
