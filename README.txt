...
With powerful features like event/news emailing this plugin is your go-to solution for professional and automated email campaigns.
...
- Monitor campaign performance with an intuitive analytics dashboard[PRO].
...
== Screenshots ==
1. **Analytics:** Email Analytics, Email Performance, Subscription Rate.
2. **Email Automation:** Schedule automatic email campaign.
3. **Event Emailing:** Send occasional emails in one click.
4. **SMTP:** Configure sending mail server to ensure confirm email delivery.
...
Co-developed by [Uzzam Afroz](https://zamy.dev).

== Support ==

Need help? Contact us through the [plugin website](https://abenplugin.com).